...
import { DEFAULT_RATE_LIMIT_RPM, ADMIN_API_KEY, API_KEYS } from "../config.js";
import { logger } from "../logger.js";
export async function verifyApiKey(request, model) {
  let key = "";
...
export async function logUsage(projectId, apiKeyId, model, promptTokens, completionTokens, durationMs, statusCode) {
  if (!supabase) return;
  try {
